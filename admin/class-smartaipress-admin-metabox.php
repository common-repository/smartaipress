...
/**
 * SmartAIPress Admin Metabox Class
 *
 * The SmartAIPress Admin Metabox class is responsible for managing and rendering metaboxes
 * within the WordPress administration panel. It provides a structured way to display and
 * interact with additional content and options related to SmartAIPress features and settings.
 *
 * @package SmartAIPress
 * @subpackage Admin
 * @since 1.0.0
 */
class Smartaipress_Admin_Metabox {

    /**
     * Callback function to add the metabox to posts and pages.
     */
    function register_metaboxes() {
        ...
        foreach ($screens as $screen) {
            add_meta_box(
                'smartaipress_openai_metabox', 
                'SmartAIPress',
                array( $this, 'render_metabox' ), // Callback to render the metabox content
                $screen,
                'side',
                'high'
            );
    ...
    function render_metabox($post) { 
        ...
        $metabox_title          = smartaipress('helper')->get_post_type_title();
        ...
        <div id="smartaipress-metabox">
            <?php if (!empty($openai_api_key)) : ?>
            <div class="smartaipress-tabs">
                <div class="smartaipress-tab smartaipress-tab-active" data-tab="smartaipress-prompt-metabox"><?php esc_html_e( 'Prompt', 'smartaipress' ); ?></div>
                <div class="smartaipress-tab" data-tab="smartaipress-custom-prompt-metabox"><?php esc_html_e( 'Custom Prompt', 'smartaipress' ); ?></div>
            </div>
            <div class="smartaipress-tab-content smartaipress-tab-active" id="smartaipress-prompt-metabox">
                <form>
                    <?php wp_nonce_field('smartaipress_data_nonce', 'smartaipress_nonce'); ?>
                    <div class="sap-row">
                        <label for="smartaipress-meta-input-post-title"><?php echo esc_html( $metabox_title ); ?> <span class="sap-required">*</span></label>
                        <input type="text" id="smartaipress-meta-input-post-title" name="smartaipress[post_title]" class="sap-form-control smartaipress-input" placeholder="<?php esc_attr_e( 'Article title', 'smartaipress' ); ?>" value="<?php echo esc_attr( sanitize_text_field( $default_post_title ) ); ?>" />
                    </div>
                    <div class="sap-row">
                        <label for="smartaipress-meta-input-focus-keyword"><?php esc_html_e( 'Focus Keyword', 'smartaipress' ); ?></label>
                        <input type="text" id="smartaipress-meta-input-focus-keyword" name="smartaipress[focus_keyword]" class="sap-form-control smartaipress-input" placeholder="<?php esc_attr_e( 'Focus keywords (separate with a comma)', 'smartaipress' ); ?>"/>
                    </div>
                    <div class="sap-row">
                        <label for="smartaipress-meta-select-openai-model"><?php esc_html_e( 'OpenAI Model', 'smartaipress' ); ?></label>
                    ...
                    <div class="sap-row">
                        <label for="smartaipress-meta-select-language"><?php esc_html_e( 'Language', 'smartaipress' ); ?></label>
                        <select name="smartaipress[openai_default_language]" class="sap-form-control smartaipress-select" id="smartaipress-meta-select-language">
                    ...
                    <div class="sap-row">
                        <label for="smartaipress-meta-input-max-length"><?php esc_html_e( 'Maximum Length in Words', 'smartaipress' ); ?></label>
                        <input name="smartaipress[maximum_length]" type="number" placeholder="<?php esc_attr_e( 'Maximum length', 'smartaipress' ); ?>" class="sap-form-control smartaipress-input" id="smartaipress-meta-input-max-length" value="<?php echo esc_attr( sanitize_key( $default_max_length ) ); ?>">
                    </div>
                    <div class="sap-row">
                        <label for="smartaipress-meta-select-creativity"><?php esc_html_e( 'Creativity', 'smartaipress' ); ?></label>
                        <select name="smartaipress[creativity]" class="sap-form-control smartaipress-select" id="smartaipress-meta-select-creativity">
                    ...
                    <div class="sap-row">
                        <label for="smartaipress-meta-select-tone-of-voice"><?php esc_html_e( 'Tone of Voice', 'smartaipress' ); ?></label>
            ...
            <div class="smartaipress-tab-content" id="smartaipress-custom-prompt-metabox" style="display: none;">
